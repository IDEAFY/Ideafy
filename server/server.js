...
CouchDBTools.requirejs(["CouchDBUser", "Transport", "CouchDBStore", "Store", "Promise"], 
    function(CouchDBUser, Transport, CouchDBStore, Store, Promise) {
       ...
       io.set('transports', [                     // enable all transports (optional if you want flashsocket)
        ...
        olives.handlers.set("GetAchievements", function(json, onEnd){
                ...
                var userCDB = new CouchDBStore(), // user doc
                    ...
                    ssCDB = new CouchDBStore(), // all single sessions completed by user
                    msCDB = new CouchDBStore(), // all multi-user sessions initiated by user
                    questionsCDB = new CouchDBStore(),
        ...
        olives.handlers.set("Notify", function(json, onEnd) {
                ...
                insertContact = function(userid, contact, onEnd){
                        ...
                        getDocAsAdmin(userid, cdb).then(function(){
                                ...
                                if (contact.type === "user") news.unshift({"type": "CX+", "date": json.date, "content": {userid:json.author, username:contact.username}});
                ...
                removeContact = function(userid, contact, onEnd){
                        ...
                        getDocAsAdmin(userid, cdb).then(function(){
                                ...
                                if (contact.type === "user") news.unshift({"type": "CX-", "date": json.date, "content": {userid:contact.userid, username:contact.username}});
                                cdb.set("connections", contacts);
                                cdb.set("news", news);
                                updateDocAsAdmin(userid, cdb).then(function(){
                                        onEnd("ok");
