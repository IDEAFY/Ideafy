...
define(["Olives/OObject", "Store", "Olives/Model-plugin", "Olives/Event-plugin", "service/map", "service/utils", "service/avatar", "service/config", "twocents/writetwocent", "twocents/twocentlist", "Observable"], 
        function(Widget, Store, Model, Event, Map, Utils, Avatar, Config, WriteTwocent, TwocentList, Observable){
                ...
                //setup
                        ...
                        _widget.template='<div class="public-idea"><div class="header blue-dark"><a href="#public-2cents" data-publicdetail="bind: toggleTwocentShare, doc.authors" data-publicdetailevent="listen: mousedown, action" class="option left"></a><span data-label="bind: innerHTML, publicdetailsheadertitle"></span><a href="#public-favorites" data-publicdetail="bind: toggleRateEdit, doc.authors" data-publicdetailevent="listen: mousedown, action" class="option right"></a></div><div class = "detail-contents"><div class="detail-header"><div class="avatar" data-publicdetail="bind:setAvatar, doc.authors"></div><h2 data-publicdetail="bind:innerHTML,doc.title"></h2><span class="date" data-publicdetail="bind:date, doc.creation_date"></span><br><span class="author" data-publicdetail="bind:setAuthor,doc.authornames"></span><span class="commentlbl" data-publicdetail="bind: setWrotelbl, doc.authors"></span></div><div class="detail-body"><p data-publicdetail="bind:innerHTML,doc.description"></p><p data-publicdetail="bind:innerHTML,doc.solution"></p></div><div class="detail-footer"><div class ="rateIdea"><a class="item-acorn"></a><div class="rating" data-publicdetail="bind:setRating,value.rating"></div><div class="publicButton" data-publicdetail="bind:toggleVoteButton, doc.votes" name="vote" data-publicdetailevent="listen: mousedown, press; listen: mouseup, vote;" data-label="bind: innerHTML, votebuttonlbl"></div><div id="ratingPopup" class="popup"><ul class="acorns" data-vote="foreach"><li class="item-acorn" data-vote="bind: setIcon, active" data-publicdetailevent="listen: mousedown, previewVote; listen: mouseup, castVote"></li></ul></div></div></div></div><div id="public-writetwocents" class="invisible" data-publicdetail="bind: displayWriteTwocent, doc.authors"></div><div id="public-twocents" class="twocents" data-publicdetail="bind: displayTwocentList, doc.twocents"></div></div>';
