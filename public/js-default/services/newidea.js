                ...
                return function newIdeaConstructor(){
                        ...
                        _widget.plugins.addAll({
                                ...
                                "attach": new Model(_attachment, {
                                        showCustom : function(custom){
                                                (custom) ? this.setAttribute("style", "display:inline-block;") : this.setAttribute("style", "display:none;");
                                        }        
                                }),
