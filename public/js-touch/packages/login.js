...
define(["OObject" ,"Amy/Stack-plugin", 
	...
	function(Widget, Stack, Map, Event, Config, Model, Spinner){
		...
		//setup
		        ...
		        _loading.template = '<div id="loading" class="invisible"><p data-label="bind: innerHTML, loadingmessage"></p><div id="loadingspin"></div></div>';
		...
		//logic
			_login.setScreen = function setScreen(name){
