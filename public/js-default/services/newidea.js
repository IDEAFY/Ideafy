...
define(["OObject", "service/map", "Bind.plugin", "Event.plugin", "service/config", "CouchDBDocument", "lib/spin.min"],
        function(Widget, Map, Model, Event, Config, Store, Spinner){
                ...
                return function newIdeaConstructor(){
                        ...
                        _widget.template = '<div><div class = "header blue-dark"><span data-labels="bind: innerHTML, createidealbl"></span><div class="close-popup" data-newideaevent="listen:mousedown, cancel"></div></div><form class="form"><div class="idealang"><div class="currentlang" data-newidea="bind: displayLang, lang" data-newideaevent="listen: mouseup, showLang"></div><ul class="invisible" data-select="foreach"><li data-select="bind: setBg, name; bind: setSelected, selected" data-newideaevent="listen: mousedown, selectFlag; listen: mouseup, setLang"></li></ul></div><input maxlength=40 type="text" class="input newideatitle" data-labels="bind:placeholder, ideatitleplaceholder" data-newidea="bind: value, title" data-newideaevent="listen: input, resetError"><textarea class="description input" data-labels="bind:placeholder, ideadescplaceholder" data-newidea="bind: value, description" data-newideaevent="listen: input, resetError"></textarea><textarea class="solution input" data-labels="bind:placeholder, ideasolplaceholder" data-newidea="bind: value, solution" data-newideaevent="listen: input, resetError"></textarea><legend class="a-legend">Add attachments</legend><div class="attachments"><select><option selected disabled style="display:none;">Choose category</option><option>Business model</option><option>Marketing</option><option>Architecture</option><option>Specifications</option><option>Other, please specify</option></select><input maxlength=40 type="text" placeholder="Enter category" class="input custom-cat"><input maxlength=40 type="text" placeholder="Enter name" class="input a-name"><ul class="a-list"><li><label class="a-type">icon</label><label call=a-name>filename</label><label calss="a-cat">category</label></li></ul><div class="a-tools"><div class="toolbox-button"><div class="upload-button" name="upload"></div><legend data-labels="bind:innerHTML, filelbl">File</legend></div><div class="toolbox-button"><div class="importpic-button" name="import"></div><legend data-labels="bind:innerHTML, imagelbl">Picture</legend></div><div class="toolbox-button"><div class="drawingtool-button" name="drawing"></div><legend data-labels="bind:innerHTML, drawinglbl">Drawing</legend></div></div></div><div class="visibility-input"><input class="visibility-slider" type="range" min=0 max=1 value =1 data-newideaevent="listen:change, toggleVisibility" data-wbtools="bind:setReadonly, readonly"><div class="private" data-newidea="bind: setVisibility, visibility"></div></div><div class="newidea-footer"><div class="publicwarning invisible" data-labels="bind: innerHTML, publicwarning" data-newidea="bind: setWarning, visibility"></div><span class="errormsg" data-errormsg="bind:setError, error"></span><div class="sendmail" data-newideaevent="listen:mousedown, press; listen:mouseup, upload" data-labels="bind:innerHTML, publishlbl">Publish</div></div></form></div>';
