define("Ideafy/Public/List", ["Olives/OObject", "CouchDBStore", 
	"Config", "Olives/Model-plugin", "Ideafy/Utils"], 
	function(Widget, Store, Config, Model, Utils){
		function ListPublicConstructor($db, $design, $view, $query){
			...
			this.template = "<ul class='ideas-list' data-listideas='foreach'>" +
									"<li class='list-item'>" +
