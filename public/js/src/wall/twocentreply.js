define("TwocentReplyList", ["Olives/OObject", "Store", "Olives/Model-plugin", "Olives/Event-plugin", "Ideafy/Utils", "Config", "WriteTwocentReply"],
        function(Widget, Store, ModelPlugin, EventPlugin, Utils, Config, WriteTwocentReply){
