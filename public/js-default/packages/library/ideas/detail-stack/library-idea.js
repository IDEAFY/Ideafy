                        ...
                        _widget.plugins.addAll({
                                ...
                                "alist": new Model(_alist,{
                                        ...
                                        showRating : function(votes){
                                                (votes && votes.length) ? this.classList.remove("invisible") : this.classList.add("invisible");
                                        }
                                }),
