...
define(["OObject", "Amy/Stack-plugin", "Amy/Control-plugin", 
	...
	function(Widget, Stack, Control, Public, Library, Brainstorm, Connect, Dashboard, Map, Config, Notify, NewIdea, Help, New2Q, New2C, Tips){
		...
		//setup
			...
			_widget.template = '<nav id="dock" class="invisible" data-dockcontrol="radio:a,selected,touchstart,setCurrentWidget"><a class="dock-item selected" href="#public" data-dockcontrol="init"></a><a class="dock-item" href="#library"></a><a class="dock-item" href="#brainstorm"></a><a class="dock-item" href="#connect"></a><a class="dock-item" href="#dashboard"></a></nav><div class="stack" data-dockstack="destination"></div>';
			
			_widget.place(Map.get("mainscreen"));
